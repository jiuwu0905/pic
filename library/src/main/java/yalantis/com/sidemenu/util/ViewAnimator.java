...
public class ViewAnimator<T extends Resourceble> {
        ...
        for (int i = 0; i < size; i++) {
            ...
            viewMenu.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    switchItem(list.get(finalI),finalI, location[1] + v.getHeight() / 2);
                }
            });
            ((TextView) viewMenu.findViewById(R.id.menu_item_image)).setText(list.get(i).getItemName());
    ...
    private void switchItem(Resourceble slideMenuItem,int itemPosition, int topPosition) {
        this.screenShotable = animatorListener.onSwitch(slideMenuItem, screenShotable, itemPosition,topPosition);
        hideMenuContent();
    }
